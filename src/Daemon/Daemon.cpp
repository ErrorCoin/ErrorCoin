...
int main(int argc, char* argv[])
{
  ...
  try {
	...
	std::string daemonstartup = "All your base are belong to us!";
	std::string daemonstartup2 = "404: Coin not found.";
	std::string daemonstartup3 = "Oh, you thought this was an actual cryptocurrency? Jokes on you!";
        std::string daemonstartup4 = "Ah, I see you're a man of culture as well.";
	std::string daemonstartup5 = "Ayyy lmao";
	PRNG rng;

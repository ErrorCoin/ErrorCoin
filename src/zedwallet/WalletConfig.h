...
namespace WalletConfig
{
    ...
    const std::string addressPrefix = "eRr";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "ERR";
    ...
    const std::string daemonName = "ErrorCoind";

    /* The name to call this wallet */
    const std::string walletName = "ErrorWallet";
    ...
    const std::string contactLink = "https://discord.gg/BFCU6Ns";
